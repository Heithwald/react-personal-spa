  ...
  return (
    ...
    >
      ...
      <div className="list direction-row">
        ...
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">JavaScript (ES9+)</h4>
        ...
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">React v17+</h4>
        ...
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">Redux Tooolkit</h4>
          <h6 className="subtitle">App state management</h6>
        </div>
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">Material-UI</h4>
          <h6 className="subtitle">
        ...
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">Framer-Motion</h4>
          <h6 className="subtitle">Animations and transitions</h6>
        </div>
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">JEST</h4>
          <h6 className="subtitle">
        ...
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">Axios</h4>
          <h6 className="subtitle">Promise based HTTP client</h6>
        </div>
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">Formik</h4>
          <h6 className="subtitle">Simple form building and hadling</h6>
        </div>
        <div className="list-item">
          <div className="icon-placeholder"></div>
          <h4 className="title">Storybook</h4>
          <h6 className="subtitle">
            UI components' documenting and organizing
          </h6>
        </div>
      </div>
    </motion.div>
